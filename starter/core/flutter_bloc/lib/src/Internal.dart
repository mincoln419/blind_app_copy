...
extension InternalFlowBuilder on FlowBlocBuilder {
  static BlocWidgetBuilder<BlocT> when<DataT, BlocT extends IFlowState<DataT>>({
    ...
    return (context, state) {
      ...
      } else if (orElse != null && state is IFlowState<DataT>) {
...
extension InternalFlowListener on FlowBlocListener {
  static BlocWidgetListener<BlocT> when<DataT, BlocT extends IFlowState<DataT>>({
    ...
    return (context, state) {
      ...
      } else if (onOrElse != null && state is IFlowState<DataT>) {
        return onOrElse(context, state);
      }
    };
  }
}